    ...
    <form name="login" method="post" action="http://localhost/php/apps/mcapmany/new_profile.php" class="outer">
        <ul class="signup_display">
            ...
            <li><label>新規ID入力</label><br>
                <input type="text" name="signup_id" placeholder="ID" class="inputbox" required></li>
            <li><label>ID入力※確認</label><br>
            <input type="text" name="signup_idcheck" placeholder="ID※確認" class="inputbox" required></li>
            <li><label>パスワード</label><br>
                <input type="password" name="signup_pass" id="pass" class="inputbox" required></li>
            <li><label>パスワード※確認</label><br>
                <input type="password" name="signup_passcheck" id="pass" class="inputbox" required></li>
